...
var Guest_List = ["Muzammil", "Owais", "Farah", "Zeeshan", "Anam", "Zain"];
Guest_List.pop();
Guest_List.push("Moosa");
console.log("The invited guests are as follows:\n\t ".concat(Guest_List[0]));
console.log("\t ".concat(Guest_List[1]));
console.log("\t ".concat(Guest_List[2]));
console.log("\t ".concat(Guest_List[3]));
console.log("\t ".concat(Guest_List[4]));
console.log("\t ".concat(Guest_List[5]));
...
console.log("\t ".concat(Guest_List[0]));
console.log("\t ".concat(Guest_List[1]));
console.log("\t ".concat(Guest_List[2]));
console.log("\t ".concat(Guest_List[3]));
console.log("\t ".concat(Guest_List[4]));
console.log("\t ".concat(Guest_List[5]));
console.log("\t ".concat(Guest_List[6]));
console.log("\t ".concat(Guest_List[7]));
console.log("\t ".concat(Guest_List[8]));
...
console.log("Sorry ".concat(Guest_List[8], ", we cannot invite you today"));
Guest_List.pop();
console.log("Sorry ".concat(Guest_List[7], ", we cannot invite you today"));
Guest_List.pop();
console.log("Sorry ".concat(Guest_List[6], ", we cannot invite you today"));
Guest_List.pop();
console.log("Sorry ".concat(Guest_List[5], ", we cannot invite you today"));
Guest_List.pop();
console.log("Sorry ".concat(Guest_List[4], ", we cannot invite you today"));
Guest_List.pop();
console.log("Sorry ".concat(Guest_List[3], ", we cannot invite you today"));
Guest_List.pop();
console.log("Sorry ".concat(Guest_List[2], ", we cannot invite you today"));
Guest_List.pop();
console.log("Don't worry ".concat(Guest_List[0], " and ").concat(Guest_List[1], " you both are still invited"));
Guest_List.pop();
Guest_List.pop();
