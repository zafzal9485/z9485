...
const album1 = make_album("Ali Zafar","Sayonee",5);
const album2 = make_album("Atif Aslam","Taqdeer",10);
//Now i will make a 3rd entry in which i will not enter the number of tracks of the artist in the album.
const album3 = make_album("Shreya Goswel","Chura lia hai tumne jo dil ko");
